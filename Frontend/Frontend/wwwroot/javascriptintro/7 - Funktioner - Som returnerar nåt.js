...
function funRet2() {
    ...
    */
    ...
    function superImportant(input, up) {
        if (up == true) {
            return `****** ${input.toUpperCase()} ******`;
        }
        else if (up == false) {
...
function funRetExtra2() {
    ...
    */
    ...
    function skrivUtProduktInfo(vara, pris) {
        if (vara == "tidning" || vara == "flyg") {
            console.log(`Momsen för en/ett ${vara} som kostar ${pris}kr är ${beräknaMoms(vara, pris)} kr`);
        }
        else if (vara == "restaurangbesök" || vara == "falafel") {
            console.log(`Momsen för en/ett ${vara} som kostar ${pris}kr är ${beräknaMoms(vara, pris)}kr`);
        }
